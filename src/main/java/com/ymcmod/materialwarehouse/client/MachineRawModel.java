...
public class MachineRawModel implements IModel {
    ...
    public MachineRawModel(String domain, String modelName, boolean hasSecondState) throws Exception {
	...
	public IBakedModel bake(IModelState state, VertexFormat format,
		...
		return new MachineModel(firstStateModel, secondStateModel);
	}
}
