...
public class GenericItemFinalizedModel implements IPerspectiveAwareModel {
	private IBakedModel parentModel;
	private ImmutableList<BakedQuad> quads;

	public GenericItemFinalizedModel(IBakedModel parentModel, ImmutableList<BakedQuad> quads){
