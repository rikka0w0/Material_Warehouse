...
public class CustomModelLoader implements ICustomModelLoader{
	...
	public boolean accepts(ResourceLocation modelLocation) {
		...
		else if (SimpleTextureBlockStateMapper.accepts(resPath))
			return true;
		
		else if (MachineBlockStateMapper.accepts(resPath))
			return true;
	...
	public IModel loadModel(ResourceLocation modelLocation) throws Exception {
		...
		if (resPath.startsWith(PATH_STI)){
			...
			return SimpleTextureBlockStateMapper.loadModel(domain, resPath, variantStr);
		}
		
		else if (MachineBlockStateMapper.accepts(resPath)) {
			String variantStr = ((ModelResourceLocation)modelLocation).getVariant();
			return MachineBlockStateMapper.loadModel(domain, resPath, variantStr);
		}
